...
// Citim valoarea analogică de la senzorul MQ135
  ...
  Serial.print(",");
    ...
    Serial.println("Calitate Foarte Buna a Aerului sub 800 ppm");
  } 
  else if (concentratieGaz >= 16 && concentratieGaz < 20) {
    Serial.println("Calitate Buna a Aerului 800-1000 ppm");
  } 
  else if (concentratieGaz >= 18 && concentratieGaz < 22) {
    Serial.println("Calitate moderata a Aerului 1000-1200 ppm");
  } 
  else if (concentratieGaz >= 22 && concentratieGaz < 26) {
    Serial.println("Calitate slaba a Aerului 1200-1500 ppm");
  } 
  else {
    Serial.println("Calitate foarte slaba a Aerului peste 1500 ppm");
  }
  //Serial.println(concentratieGaz);
  Serial.print("\n");
